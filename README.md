# Data sourcing Kaggle Datasets Python
...
```
cd existing_repo
git remote add origin https://gitlab.com/the-bootcamp-project/packages/data-science/sourcing-kaggle-datasets-python.git
git branch -M main
